  ...
  return (
    <div className="w-full max-w-[420px]">
      ...
      <form onSubmit={handleSubmit} className="space-y-4">
        ...
        <div className="flex items-center justify-between pt-0.5">
          <label className="flex items-center gap-2.5 cursor-pointer group">
            <div
              ...
              style={{
                border: rememberMe ? '1.5px solid #6366f1' : '1.5px solid #d1d5db',
          ...
          <a
            ...
            style={{ color: '#4f46e5', fontFamily: "'Inter', sans-serif" }}
        ...
        <button
          type="submit"
          className="w-full py-3 px-4 rounded-xl text-white text-[15px] font-semibold transition-all duration-150 mt-2"
          style={{
      ...
      <div className="flex items-center gap-3 my-6">
        ...
        <span
          className="text-xs font-medium text-gray-400 px-1"
          style={{ fontFamily: "'Inter', sans-serif" }}
        >
          or
        </span>
      ...
      <button
        type="button"
        className="w-full flex items-center justify-center gap-3 py-3 px-4 rounded-xl text-[15px] font-medium text-gray-700 bg-white transition-all duration-150"
        style={{
